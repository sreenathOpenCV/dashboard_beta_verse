...
import { usePostAttendeesMutation } from '@/services/webinarServices';
...
const Page: React.FC = () => {
  ...
  const [postAttendees] = usePostAttendeesMutation();
  ...
  return (
    <div className={styles.mainContainer}>
      <h4 className={styles.title}>Webinar Attendees</h4>
